...
Таблица состоит из строк и столбцов. Каждый элемент таблицы можно обозначить как:
...
Размер таблицы определяется количеством строк и столбцов:
...
Текст в таблице может быть выровнен по-разному:
- по левому краю  
- по центру  
- по правому краю  
...
Иногда необходимо объединять ячейки таблицы. Это можно представить как объединение элементов:
